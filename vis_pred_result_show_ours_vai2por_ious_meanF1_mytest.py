...
from deeplab.class_vis_finally_fix_model_v2p import Res_Deeplab
...
SNAPSHOT_DIR = './experiments/restores/train_without_g_siamese_potirrg_vai_outputDA_2batch_newUpsample_8000'
RESULT_PATH = './experiments/evaluate_result/train_without_g_siamese_potirrg_vai_outputDA_2batch_newUpsample_8000/'
LOG_PATH = './experiments/TensorboardLogs/evaluate_train_without_g_siamese_potirrg_vai_outputDA_2batch_newUpsample_8000'
DIFF_PATH = './experiments/pred_gt_diff/diff_TGRS_train_without_g_siamese_potirrg_vai_outputDA_2batch_newUpsample_8000'
PRED_PATH = './experiments/pred_result/pred_result_TGRS_train_without_g_siamese_potirrg_vai_outputDA_2batch_newUpsample_8000'
WEIGHT_DECAY = 0.0005


## gai
RESTORE_FROM = './best_model/class_vis_target_v2p_change_numclass_2_softmax_bce_30000.pth'
...
def mytest(model, step, testloader,device,writer,palette):
    ...
    for index, batch in enumerate(testloader):
        ...
        size = size[0].numpy()
        output0,output1,visout_0,visout_1,visout_2,visout_3,visout_4,l2,l4,l6,l8,vis_E,vis_V,vis_U = model(Variable(image, volatile=True).cuda())
        output = output0
...
def main():
    ...
    miou = mytest(model, checkpoint, target_testloader, device, writer,palette)
