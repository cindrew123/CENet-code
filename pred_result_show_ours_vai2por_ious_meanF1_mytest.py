...
from deeplab.finally_fix_model import Res_Deeplab
...
## gai
RESTORE_FROM = './best_model/target_ours_potirrg_to_vai_change_numclass_2_softmax_bce_54000.pth'
...
def mytest(model, step, testloader,device,writer,palette):
    ...
    return miou, ious,mean_F1,class_F1
...
def main():
    ...
    miou, ious,mean_F1,class_F1 = mytest(model, checkpoint, target_testloader, device, writer,palette)
